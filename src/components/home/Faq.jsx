        ...
        <div>
            ...
            <section className="about-us-section">
                ...
                <div className="about-nav">
                    <button 
                    className={abaPrincipal === 'faq' ? 'active' : ''} 
                    onClick={() => setAbaPrincipal('faq')}
                    >
                    Perguntas Frequentes
                    </button>
                    <button 
                    className={abaPrincipal === 'quemSomos' ? 'active' : ''} 
                    onClick={() => setAbaPrincipal('quemSomos')}
                    >
                    Quem somos?
                    </button>
                    <button 
                    className={abaPrincipal === 'parcerias' ? 'active' : ''} 
                    onClick={() => setAbaPrincipal('parcerias')}
                    >
                    Parcerias
                    </button>
                    <button 
                    className={abaPrincipal === 'suporte' ? 'active' : ''} 
                    onClick={() => setAbaPrincipal('suporte')}
                    >
                    Ajuda & Suporte
                    </button>
                </div>
                ...
                {abaPrincipal === 'faq' ? (
                    ...
                    <button className="btn-action-about">Saiba mais</button>
                    </div>
                )}
                </div>
            </section>
